...
@Service
public class AddChiefEditorToReviewerListService implements JavaDelegate {
	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		ArrayList<String> listaRecezenata = new ArrayList<>();
		String glavniUrednik = (String) execution.getVariable("glavni_urednik_login");
		listaRecezenata.add(glavniUrednik);
		execution.setVariable("listaRecezenata", listaRecezenata);

		log.info("glavniUrednik: {}", glavniUrednik);
	}
}
